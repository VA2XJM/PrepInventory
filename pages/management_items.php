...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Management - Items</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						...
						<a href="management_items_add.php" title="Add new item" alt="Add new item">Add a new item</a>
						<hr>
							<?php
								...
								if (mysqli_num_rows($result) < 1) { print "No item has been added yet."; }
									...
									while($row = mysqli_fetch_assoc($result)) {
										print '<img src="'. $row['icon'] .'" class="icon"> ' . $row["name"] . ' <a href="management_items_edit.php?id='. $row['id'] .'"><i class="fa fa-pencil-square fa-fw"></i></a><br>';
									}
								}
							?>
						</div>
