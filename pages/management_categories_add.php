<?PHP
	...
	elseif (!empty($_POST['icon']) && empty($_POST['name'])) { $panel_type = 'panel-danger'; $panel_notice = "ERROR: Name is mandatory."; }
		...
		if (!preg_match('!^[\w -]*$!', $_POST['name'])) { 
			...
			if ($parent_lev == '0') { $table = 'inv_categories_1'; $parent_id = '0'; }
			elseif ($parent_lev == '1') { $table = 'inv_categories_2'; }
			...
			if ($result) {
				...
				$panel_notice = "Category has been added. <a href=\"management_categories.php\" title=\"Return\" alt=\"Return\">Return to categories</a>";
			}
			else {
				$panel_type = 'panel-danger';
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Management - Categories - Add</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
